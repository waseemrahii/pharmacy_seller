...
// import { FaSearch, FaFilter } from 'react-icons/fa'; // Example React Awesome Icons
// // import './TransactionTable.css'; // Import your custom styles
...
//   return (
//     <div className="col-md-12 snipcss-D7iT1">
//       <div className="card">
...
//                 Transaction table
//                 <span className="badge badge-soft-dark fz-12">{filteredTransactions.length}</span>
//               </h5>
//             </div>
...
//         <table
//           id="datatable"
//           className="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 style-yPOF2"
//         >
