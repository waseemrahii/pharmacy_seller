      ...
      <div className="card h-100 remove-card-shadow">
        <div className="card-header">
          <h4 className="d-flex align-items-center text-capitalize gap-10 mb-0">
            <img width="20" src="/most-popular-product.png" alt="" /> Most Popular Products
          </h4>
        </div>
            ...
            <div className="col-12">
              <div className="grid-card-wrap">
                <div className="cursor-pointer grid-card basic-box-shadow get-view-by-onclick ">
                  <div>
                    <img className="avatar avatar-bordered border-gold avatar-60 rounded" src="/2023-06-13-64884ce5791fe.png" alt="Red Flash Melting Matte Waterproof Lip Stick - P05Image" />
                  </div>
                ...
                <div className="cursor-pointer grid-card basic-box-shadow get-view-by-onclick" >
                  <div>
                    <img className="avatar avatar-bordered border-gold avatar-60 rounded" src="/2022-04-23-62636369a0855.png" alt="Ladies Winter Long Sleeve SweaterImage" />
                  </div>
                ...
                <div className="cursor-pointer grid-card basic-box-shadow get-view-by-onclick">
                  <div>
                    <img className="avatar avatar-bordered border-gold avatar-60 rounded"
                     src="/2022-04-20-625fe97736a17.png" alt="Simple Mobile Carrier-Locked Galaxy A50 4G LTE Prepaid Smartphone - BlacImage" />
                  </div>
