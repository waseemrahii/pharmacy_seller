...
//   return (
//     <>
//       <div className="bg-[#FFFFFF] h-52 w-[96%] border-transparent rounded-lg border-4 ml-5 mr-5 mt-8 box-border hover:shadow-lg">
//         <div className="text-[#334257] pl-4 pt-3 font-semibold">
//           <p>Filter Order</p>
//         </div>
//         <div className="grid grid-cols-4 gap-2 pl-4 pt-3">
//           <p className="text-[#1f1e1ee5]"> Order Type</p>
//           <p className="text-[#1f1e1ee5]"> Store</p>
//           <p className="text-[#1f1e1ee5]"> Customer</p>
//           <p className="text-[#1f1e1ee5]"> Data Type</p>
//         </div>
//         <div className="grid grid-cols-4 gap-2 pl-4 pt-3">
//           <select className="border border-neutral-400 rounded  text-base text-justify pt-3 hover:border-blue-500 hover:bg-white hover:text-black">
...
//           <select className="border border-neutral-400 rounded  text-base text-justify pt-3 hover:border-blue-500 hover:bg-white hover:text-black">
//             <option value="Inhouse" className="">
//             Inhouse
//             </option>
