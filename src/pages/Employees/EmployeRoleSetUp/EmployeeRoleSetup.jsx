...
// import { FaSearch, FaDownload, FaChevronDown, FaEdit, FaTrash } from 'react-icons/fa'; // React Icons
// import { BsToggleOn, BsToggleOff } from 'react-icons/bs'; // Toggle icons
// import './EmployeeRoleSetup.css'
...
//                     <form id="submit-create-role" className="text-start snipcss0-3-6-7">
...
//                                 <input type="checkbox" id="select-all" className="cursor-pointer snipcss0-6-16-17" />
//                                 <label className="title-color mb-0 cursor-pointer text-capitalize snipcss0-6-16-18" htmlFor="select-all">Select all</label>
//                             </div>
//                         </div>
//                         {/* Add module permission checkboxes here as per requirement */}
...
//                                 <button type="button" className="btn btn-outline--primary text-nowrap snipcss0-6-72-73">
...
//                                         <td className="text-capitalize snipcss0-7-92-95">
//                                             {role.modules.join(', ')}
//                                         </td>
//                                         <td className="snipcss0-7-92-99">{role.createdAt}</td>
//                                         <td className="snipcss0-7-92-100">
//                                             <label className="switcher snipcss0-9-101-104">
//                                                 <input type="checkbox" className="switcher_input snipcss0-10-104-105" checked={role.status} />
//                                                 <span className="switcher_control snipcss0-10-104-106">
//                                                     {role.status ? <BsToggleOn className="text-success" /> : <BsToggleOff className="text-danger" />}
//                                                 </span>
//                                             </label>
//                                         </td>
//                                         <td className="snipcss0-7-92-107">
//                                             <div className="d-flex gap-2 justify-content-center snipcss0-8-107-108">
//                                                 <button type="button" className="btn btn-outline--primary btn-sm square-btn snipcss0-9-108-109">
//                                                     <FaEdit className="snipcss0-10-109-110" />
//                                                 </button>
//                                                 <button type="button" className="btn btn-outline-danger btn-sm delete square-btn snipcss0-9-108-111">
//                                                     <FaTrash className="snipcss0-10-111-112" />
//                                                 </button>
//                                             </div>
//                                         </td>
//                                     </tr>
