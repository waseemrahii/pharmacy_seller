...
import { FaGlobe, FaCommentDots, FaShoppingCart, FaSignOutAlt } from 'react-icons/fa';
import './Header.css'
    ...
    <div>
      ...
      <div className="header flex items-center justify-between py-2 px-6 shadow fixed top-0 left-0 right-0 bg-white z-50">
        ...
        <div className="left px-7">
          <img src="E-bazar.png" alt="Logo" width='40' style={{ height:"4rem"}} />
        </div>
          ...
          <div className="relative flex items-center mr-6">
            ...
            >
              ...
              <div className="flex items-center cursor-pointer">
                ...
                />
                  <button
            className="ml-4 flex items-center px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-red-600"
